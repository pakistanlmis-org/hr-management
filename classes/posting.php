...
class posting {
    ...
    private $conn;
    //db fileds
    protected static $db_fields = array('post_id', 'post_place_id', 'date_of_appointment', 'file', 'personal_record_id');
    public $pk_id;
    public $post_id;
	...
	locations.location_name,
        posting_record.date_of_appointment,
	posting_record.file
FROM
	posting_record
INNER JOIN posts_record ON posting_record.post_id = posts_record.pk_id
INNER JOIN locations ON posting_record.post_place_id = locations.pk_id
WHERE
