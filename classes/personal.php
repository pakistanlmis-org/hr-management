...
class personal {
    ...
    private $conn;
    //db fileds
    protected static $db_fields = array('name', 'father_name', 'gender', 'cnic', 'district_of_domicile', 'date_of_birth', 'contact_no', 'email', 'postal_address', 'pmdc_registration', 'marital_status', 'health_professional', 'residential_address', 'current_address', 'residential_city', 'current_city');
    public $pk_id;
    public $name;
    public $father_name;
    public $gender;
    ...
    public function total_records(){
        return $this->conn->query("SELECT DISTINCT pk_id FROM " . static::$table_name);
    }
    ...
    public function find_all() {
        ...
        return $this->conn->query("SELECT * FROM " . static::$table_name . " $wherestr ");
    }
	...
	personal_record.cnic,
        locations.location_name district_dom_name,
	...
	spouse.current_city AS spouse_current_city,
        ...
        posts_record.bps,
        postplace.location_name place_of_posting
FROM
	personal_record
...
LEFT JOIN locations postplace ON postplace.pk_id = posting_record.post_place_id
...
LEFT JOIN locations ON personal_record.district_of_domicile = locations.pk_id
