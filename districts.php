...
<div id="content">
    ...
    <div class="heading-buttons">
        <h3>Manage Districts / Posting Place / Received From</h3>
                ...
                <tbody>
                    ...
                    while ($row = $result->fetch_array()) {
                        ...
                        <tr class="<?php echo $class; ?>">
                            ...
                            <td class="important"><?php echo $row['lvl']; ?></td>
                            <td class="center" style="width: 200px;">
                                <a href="#edit" data-toggle="modal" id="<?php echo $row['pk_id']; ?>-fid" class="btn-action glyphicons pen" title="edit"><i></i></a>
                                <a onclick="return confirm('Are you sure you want to delete?');" href="delete_district.php?id=<?php echo $row['pk_id']; ?>" class="btn-action glyphicons bin" title="delete"><i></i></a>
                            </td>
                        </tr>
                        <?php
                        $count++;
            ...
            <div class="row-fluid">
                ...
                <div class="span12">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls"><input class="span12" id="location_name" name="location_name" type="text" /></div>
                    </div>                        
                    <div class="control-group">
